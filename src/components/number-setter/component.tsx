...
const NumberSetter: React.FC<NumberSetterProps> = ({ initValue, updateValue }: NumberSetterProps) => {
  ...
  return (
    <div className="container">
      <IonButton shape="round" size="default" onClick={() => (value > 0 ? setValue(value - 1) : null)}>
        <IonIcon slot="icon-only" icon={remove} color="white"></IonIcon>
      </IonButton>
      <IonInput ref={numberInput} onIonInput={onInput} class="custom" placeholder="000" value={value}></IonInput>
